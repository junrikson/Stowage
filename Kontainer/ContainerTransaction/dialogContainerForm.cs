...
namespace ContainerTransaction
{
    public partial class dialogContainerForm : Syncfusion.Windows.Forms.MetroForm
    {
        ...
        public dialogContainerForm(string username, string typeForm, string id = "")
        {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            if (cmbFilterColumn.SelectedItem.ToString() == "Nomor Kontainer")
            {
        ...
        private void gridView_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (gridView.SelectedRows.Count > 0)
            {
                ...
                else if (typeForm == "EditForm")
                {
                    ...
                    ((EditForm)this.Owner).btnContainerClick(code);
                    this.Close();
                }
            }
            else
