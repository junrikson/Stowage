    ...
    public partial class MainForm : Syncfusion.Windows.Forms.MetroForm
    {
        ...
        private bool CheckAuth()
        {
            ...
            string query = "SELECT c.[active], c.[new], c.[edit], c.[view], c.[delete], c.[print], c.[refresh] " +
                ...
                "WHERE a.code = @username AND c.menuCode = 'B0011' ";
            try
            {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            Grid_Load(code, container, note);
        }
        #endregion

        #region Grid

        public void Grid_Load(string code = "", string container = "", string note = "")
        {
            try
            {
                String sqlString = "SELECT id, code, date, containerCode, note, username, updated, created " +
